...
public class AuthController {
    ...
    @PostMapping("/register")//spring annotation
    @Operation(summary = "Register a new user", description = "Registers a new user with provided details.")
    public String register(@RequestBody UserDTO userDTO)//request body se jo hamari http requests h wo method parameter userdto ke object se connect ho rhi h
    {
